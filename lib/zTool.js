 ...
 * @param  {[Array]} array
 * @param  {[Function]} onEach 接受三个参数 obj key next(这个next就是用于控制下一步用的)
...
exports.extend = function(destination, source, isCover) {
    var isUndefined = us.isUndefined;
    if(isUndefined(isCover)) isCover = true;
