...
iSpriter.prototype.run = function(config) {
    ...
    this.createTasks(this, function(tasks) {
        ...
        // 所有task都抛taskDone事件后，context抛ispriter的end事件 (必须ep.after在前，ep.group在后)
...
iSpriter.prototype.combineSpriteTasks = function(spriteTaskArray) {
    ...
    combinedFileName = typeof spriteConfig.output.combine == 'string' ? spriteConfig.output.combine : 'all.css';
